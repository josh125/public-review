		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 col-md-offset-2">
					...
					<p><a class="btn btn-primary btn-lg pull-right" href="<?php echo base_url();?>writeareview/attraction/<?php echo $enc_id;?>"><i class="fa fa-star"> Write A Review</i></a>
				</div>
			<?php endforeach;?>	
			</div>
			<div class="row"><br>
