...
<p>Last Updated on November 27, 2011. These terms and conditions are effective immediately for those registering accounts after that date and will become effective December 27, 2012 for those with pre-existing accounts. To review the previous terms, please click here.</p><br><br>

<p>These terms and conditions (the <b>"Terms"</b>) govern your access to and use of Yelp's websites and mobile applications that link to or reference these Terms ("Site"). By accessing or using the Site, you are agreeing to these Terms and concluding a legally binding contract with Yelp Inc., a Delaware corporation headquartered in San Francisco, California ("Yelp"). Do not access or use the Site if you are unwilling or unable to be bound by the Terms.</p><br><br>

<h3>DEFINITIONS</h3><br>
<h4>Parties</h4>
<p><b>"You"</b> and <b>"your"</b> refer to you, as a user of the Site. A <b>"user"</b> is someone who accesses, browses, crawls, scrapes, or in any way uses the Site. <b>"We"</b>,<b>"us"</b>, and <b>"our"</b> refer to Yelp.</p><br>

<h4>Content<h4>
<p><b>"Content"</b> means text, images, photos, audio, video, location data, and all other forms of data or communication. <b>"Your Content"</b> means Content that you submit or transmit to, through, or in connection with the Site, such as ratings, reviews, compliments, invitations, check-ins, messages, and information that you publicly display or displayed in your account profile. <b>"User Content"</b> means Content that users submit or transmit to, through, or in connection with the Site. "Yelp Content" means Content that we create and make available in connection with the Site. <b>"Third Party Content"</b> means Content that originates from parties other than Yelp or its users, which is made available in connection with the Site. "Site Content" means all of the Content that is made available in connection with the Site, including Your Content, User Content, Third Party Content, and Yelp Content.</p>
...
<h3>TRANSLATION<h3>
<p>We may translate these Terms into other languages for your convenience. Nevertheless, the English version governs your relationship with Yelp, and any inconsistencies among the different versions will be resolved in favor of the English version.</p>

<h3>USING THE SITE<h3>
<h4>Eligibility</h4>
<p>To access or use the Site, you must be 18 years or older and have the requisite power and authority to enter into these Terms. You may not access or use the Site if you are a competitor of ours or if we have previously banned you from the Site or closed your account.</p><br>
...
Violate the Terms;
Modify, adapt, appropriate, reproduce, distribute, translate, create derivative works or adaptations of, publicly display, sell, trade, or in any way exploit the Site or Site Content (other than Your Content), except as expressly authorized by Yelp;
...
Take any action that imposes, or may impose, in our sole discretion, an unreasonable or disproportionately large load on Yelp's technology infrastructure or otherwise make excessive traffic demands of the Site;
...
THE YELP ENTITIES DISCLAIM LIABILITY FOR ANY (i) INDIRECT, SPECIAL, INCIDENTAL, PUNITIVE, EXEMPLARY, RELIANCE, OR CONSEQUENTIAL DAMAGES, (ii) LOSS OF PROFITS, (iii) BUSINESS INTERRUPTION, (iv) REPUTATIONAL HARM, OR (v) LOSS OF INFORMATION OR DATA.
...
TERMINATION
You may terminate the Terms at any time by closing your account, discontinuing your use of the Site, and providing Yelp with a notice of termination here. Please review our Privacy Policy	for information about what we do with your account when terminated.
...
Any failure on Yelp's part to exercise or enforce any right or provision of the Terms does not constitute a waiver of such right or provision. The failure of either party to exercise in any respect any right provided for herein shall not be deemed a waiver of any further rights hereunder.
...
The Terms, and any rights or obligations hereunder, are not assignable, transferable or sublicensable by you except with Yelp's prior written consent, but may be assigned or transferred by us without restriction. Any attempted assignment by you shall violate these Terms and be void.
